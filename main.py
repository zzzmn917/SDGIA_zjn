...
parser.add_argument('--n_sample_all', type=int, default=12)   # 12
parser.add_argument('--n_sample', type=int, default=12)   # 每个项目的最大邻居个数 12
...
parser.add_argument('--dropout_global', type=float, default=0.3, help='Dropout rate.')   # diginetica 0.2  tmall-0.3  Nowplaying 0.5
# parser.add_argument('--dropout_target', type=float, default=0, help='Dropout rate.')
...
def main():
    ...
    if opt.test:
        ...
        test_data = (train_data[0][-10:], train_data[1][-10:])
    if opt.validation:
